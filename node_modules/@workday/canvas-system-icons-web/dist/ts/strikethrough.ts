...
const icon: CanvasSystemIcon = {
  ...
  svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="wd-icon-strikethrough wd-icon" focusable="false" role="presentation" viewBox="0 0 24 24"><g fill-rule="evenodd" class="wd-icon-container"><path d="M16.604 13c.263.533.396 1.137.396 1.756C17 16.86 15.315 19 12.254 19 8 19 7.149 15.176 7.149 15.176a.458.458 0 0 1 .333-.598l2.145-.541c.109 1.23.906 2.31 2.663 2.31 1.123 0 1.811-.568 1.811-1.401 0-.682-.525-1.175-1.376-1.345l-1.758-.341a5.49 5.49 0 0 1-.9-.26h-5.57A.493.493 0 0 1 4 12.495v-.99c0-.279.226-.505.496-.505h15.008c.274 0 .496.214.496.505v.99a.503.503 0 0 1-.496.505h-2.9zm-5.916-3H7.525a4.234 4.234 0 0 1-.054-.68C7.471 6.78 9.609 5 12.072 5 16 5 16.62 8.112 16.62 8.112a.478.478 0 0 1-.326.608l-1.63.48c-.252.074-.593-.052-.743-.287 0 0-.634-1.26-1.866-1.26-1.068 0-1.757.7-1.757 1.439 0 .366.123.676.391.908z" class="wd-icon-fill"/></g></svg>',
  filename: 'wd-icon-strikethrough.svg',
  category: 'Worksheets-RTE',
  tags: ['format','data','table','grid','font','type','paragraph'],
}
export default icon