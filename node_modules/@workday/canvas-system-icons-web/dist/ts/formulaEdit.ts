...
const icon: CanvasSystemIcon = {
  ...
  svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="wd-icon-formula-edit wd-icon" focusable="false" role="presentation" viewBox="0 0 24 24"><g class="wd-icon-container"><path fill-rule="evenodd" d="M18.348 12.113c.15-.15.393-.15.543 0l1.996 1.996c.15.15.15.393 0 .543l-6.16 6.16-.002.003-1.073 1.072a.384.384 0 0 1-.271.113h-1.997a.385.385 0 0 1-.384-.384v-1.997c0-.102.04-.2.113-.271l.58-.58.002-.003 6.653-6.652zm-.575 3.96l-.847-.846-4.656 4.657.847.846 4.656-4.656zm.846-2.54l.847.848-.847.846-.846-.846.846-.847zm-6.35 6.35l.848.847h-.847v-.846z" class="wd-icon-accent" clip-rule="evenodd"/><path d="M4.812 12.301H4.5a.5.5 0 0 1-.5-.5v-.45a.5.5 0 0 1 .5-.5h.08c.61 0 .929-.291 1.06-.987l.507-2.71h-.66a.5.5 0 0 1-.5-.5v-.466a.5.5 0 0 1 .5-.5h.907l.261-1.44C6.931 2.784 7.627 2 9.194 2h.835a.5.5 0 0 1 .5.5v.48a.5.5 0 0 1-.5.5h-.501c-.682 0-1.03.334-1.175 1.132l-.175 1.076h1.343a.5.5 0 0 1 .5.5v.466a.5.5 0 0 1-.5.5H7.917l-.551 2.97c-.276 1.553-1.088 2.177-2.554 2.177zM9.963 11.707c-.135.162-.09.293.117.293h1.25c.2 0 .472-.138.6-.3 0 0 1.031-1.293 1.306-1.64l.967 1.645a.678.678 0 0 0 .53.295h1.337c.198 0 .278-.13.175-.298l-1.8-2.927 2.358-2.8c.138-.163.094-.296-.115-.296H15.43a.872.872 0 0 0-.596.293l-1.253 1.583a86.295 86.295 0 0 0-.904-1.574.688.688 0 0 0-.538-.302h-1.355c-.2 0-.278.135-.182.29l1.772 2.858-2.41 2.88z" class="wd-icon-fill"/></g></svg>',
  filename: 'wd-icon-formula-edit.svg',
  category: 'Editor',
  tags: ['format','effect','edit','planning'],
}
export default icon