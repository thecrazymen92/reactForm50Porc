...
declare const ToolbarIconButton: ({ theme, buttonRef, onToggleChange, "aria-label": iconArialabel, icon, toggled, children, ...elemProps }: ToolbarIconButtonProps) => JSX.Element;
