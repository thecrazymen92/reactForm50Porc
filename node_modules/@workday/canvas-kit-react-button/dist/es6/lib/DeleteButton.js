...
var DeleteButton = function (_a) {
    var _b = _a.theme, theme = _b === void 0 ? useTheme() : _b, _c = _a.size, size = _c === void 0 ? 'medium' : _c, buttonRef = _a.buttonRef, children = _a.children, elemProps = __rest(_a, ["theme", "size", "buttonRef", "children"]);
    return (React.createElement(ButtonContainer, __assign({ colors: getDeleteButtonColors(theme), size: size, ref: buttonRef }, elemProps),
