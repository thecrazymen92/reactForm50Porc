<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="wd-icon-contact-card-id wd-icon" focusable="false" role="presentation" viewBox="0 0 24 24">
    <g fill-rule="evenodd" class="wd-icon-container">
        ...
        <path d="M2 5.5c0-.277.225-.5.494-.5h19.012c.273 0 .494.224.494.5v14c0 .277-.225.5-.494.5H2.494A.497.497 0 0 1 2 19.5v-14zM4 7v11h16V7H4z" class="wd-icon-fill"/>
        <path d="M13 13.505c0-.279.215-.505.49-.505h3.02c.27 0 .49.214.49.505v.99a.495.495 0 0 1-.49.505h-3.02a.49.49 0 0 1-.49-.505v-.99zm0-3c0-.279.215-.505.498-.505h4.004c.275 0 .498.214.498.505v.99a.496.496 0 0 1-.498.505h-4.004a.494.494 0 0 1-.498-.505v-.99zM6 14c0-.828.674-1.5 1.5-1.5h2c.828 0 1.5.666 1.5 1.5v1.5H6V14zm1-3c0-.828.666-1.5 1.5-1.5.828 0 1.5.666 1.5 1.5 0 .828-.666 1.5-1.5 1.5-.828 0-1.5-.666-1.5-1.5z" class="wd-icon-accent"/>
    </g>
</svg>
