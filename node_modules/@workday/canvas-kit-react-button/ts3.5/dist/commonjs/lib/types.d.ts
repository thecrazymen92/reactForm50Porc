...
export declare type AnchorButtonProps<P, K extends keyof P = never> = Pick<P, Exclude<keyof P, keyof Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, K>>> & React.AnchorHTMLAttributes<HTMLAnchorElement>;
