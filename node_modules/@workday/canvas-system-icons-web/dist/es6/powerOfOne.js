...
var icon = {
    ...
    svg: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="wd-icon-power-of-one wd-icon" focusable="false" role="presentation" viewBox="0 0 24 24"><g class="wd-icon-container"><path fill-rule="evenodd" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zM4 12c0 1.005.185 1.966.523 2.852.334-.54.81-.977 1.38-1.248C6.032 11.044 8.041 9 10.514 9c1.315 0 2.533.583 3.391 1.562.444-.239.94-.368 1.457-.368 1.592 0 2.902 1.217 3.154 2.803.485.15.924.406 1.293.744A8 8 0 1 0 4 12zm6.89 2.055a.25.25 0 0 1-.34-.233v-.804a.25.25 0 0 1 .155-.231l2.301-.94a.14.14 0 0 1 .194.13v7.796a.25.25 0 0 1-.25.25h-1.095a.25.25 0 0 1-.25-.25v-5.994l-.715.276z" class="wd-icon-fill" clip-rule="evenodd"/></g></svg>',
    filename: 'wd-icon-power-of-one.svg',
    category: 'Core',
    tags: ['workday', 'chart', 'numbers', 'data-viz', 'graph', 'planning'],
};
export default icon;
